...
export default function PurchaseFormPage({
  ...
  const { data: existingOrder, isLoading: isLoadingOrder } = useQuery({
    queryKey: [`https://api-laundry-mobile.edpos.vn/api/purchase-orders/${id}`],
    enabled: Boolean(id),
    select: (data: any) => {
  ...
  const { data: existingDocuments } = useQuery({
    queryKey: [`https://api-laundry-mobile.edpos.vn/api/purchase-orders/${id}/documents`],
    enabled: Boolean(id),
    select: (data: any) => data || [],
  });
  ...
  const {
    ...
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/purchase-orders/next-po-number"],
    enabled: !isEditMode,
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          "https://api-laundry-mobile.edpos.vn/api/purchase-orders/next-po-number",
        );
        if (!response.ok) {
  ...
  const saveMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      const response = isEditMode
        ? await apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/purchase-receipts/${id}`, data)
        : await apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/purchase-receipts", data);
    ...
    onSuccess: (response) => {
      ...
      // Refresh data
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/purchase-orders"] });
  ...
  const createProductMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/products", data);
    ...
    onSuccess: (newProduct) => {
      ...
      queryClient.setQueryData(["https://api-laundry-mobile.edpos.vn/api/products"], (old: any[]) => {
        return [
          ...(old || []),
