...
export default function PurchaseFormPage({
  ...
  const { data: existingOrder, isLoading: isLoadingOrder } = useQuery({
    queryKey: [`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-orders/${id}`],
    enabled: Boolean(id),
    select: (data: any) => {
  ...
  const { data: existingDocuments } = useQuery({
    queryKey: [`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-orders/${id}/documents`],
    enabled: Boolean(id),
    select: (data: any) => data || [],
  });
  ...
  const {
    ...
    queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-orders/next-po-number"],
    enabled: !isEditMode,
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-orders/next-po-number",
        );
        if (!response.ok) {
  ...
  const saveMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      const response = isEditMode
        ? await apiRequest("PUT", `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-receipts/${id}`, data)
        : await apiRequest("POST", "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-receipts", data);
    ...
    onSuccess: (response) => {
      ...
      // Refresh data
      queryClient.invalidateQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/purchase-orders"] });
  ...
  const createProductMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest("POST", "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products", data);
    ...
    onSuccess: (newProduct) => {
      ...
      queryClient.setQueryData(["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products"], (old: any[]) => {
        return [
          ...(old || []),
