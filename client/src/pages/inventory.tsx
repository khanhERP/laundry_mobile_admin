...
export default function InventoryPage({ onLogout }: InventoryPageProps) {
  ...
  const updateStockMutation = useMutation({
    mutationFn: async (data: StockUpdateForm) => {
      ...
      const response = await fetch("https://api-laundry-mobile.edpos.vn/api/inventory/update-stock", {
        method: "POST",
        headers: {
  ...
  const updateProductTrackInventoryMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/products/${id}/track-inventory`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const cleanupMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch("https://api-laundry-mobile.edpos.vn/api/products/cleanup/inactive", {
        method: "DELETE",
      });
      if (!response.ok) {
