...
export default function InventoryPage({ onLogout }: InventoryPageProps) {
  ...
  const updateStockMutation = useMutation({
    mutationFn: async (data: StockUpdateForm) => {
      ...
      const response = await fetch("https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/inventory/update-stock", {
        method: "POST",
        headers: {
  ...
  const updateProductTrackInventoryMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products/${id}/track-inventory`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const cleanupMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch("https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products/cleanup/inactive", {
        method: "DELETE",
      });
      if (!response.ok) {
