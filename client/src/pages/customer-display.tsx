  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        // Fetch store info
        const storeResponse = await fetch('https://api-laundry-mobile.edpos.vn/api/store-settings');
        if (storeResponse.ok) {
        ...
        const cartResponse = await fetch('https://api-laundry-mobile.edpos.vn/api/current-cart');
        if (cartResponse.ok) {
