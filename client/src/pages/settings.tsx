...
export default function SettingsPage({ onLogout }: SettingsPageProps) {
  ...
  const confirmDeleteEmployee = async () => {
    ...
    try {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/employees/${employeeToDelete.id}`, {
        method: "DELETE",
      });
  ...
  const { data: productsData, isLoading: productsLoading } = useQuery<any[]>({
    queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products", { includeInactive: true }],
    queryFn: async () => {
      const response = await fetch("https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products?includeInactive=true");
  ...
  const updateStoreSettingsMutation = useMutation({
    mutationFn: async (settings: Partial<InsertStoreSettings>) => {
      const response = await apiRequest("PUT", "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/store-settings", settings);
      return response.json();
    },
    onSuccess: () => {
  ...
  const confirmDeleteCustomer = async () => {
    ...
    try {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/customers/${customerToDelete.id}`, {
        method: "DELETE",
      });
      ...
      await queryClient.refetchQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/customers"] });
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      const response = await fetch("https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/categories", {
        method: "POST",
        headers: {
      ...
      await queryClient.refetchQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/categories"] });
      await queryClient.refetchQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products"] });
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/categories/${editingCategory.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const confirmDeleteCategory = async () => {
    ...
    try {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/categories/${categoryToDelete.id}`, {
        method: "DELETE",
      });
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products/${editingProduct.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(finalProductData),
      });
  ...
  const confirmDeleteProduct = async () => {
    ...
    try {
      await apiRequest("DELETE", `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/products/${productToDelete.id}`);
  ...
  const createEInvoiceMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest(
        "POST",
        "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/einvoice-connections",
        data,
      );
      return response.json();
    },
  ...
  const updateEInvoiceMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/einvoice-connections/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const { data: invoiceTemplates = [], isLoading: templatesLoading } = useQuery<
    any[]
  >({
    queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/invoice-templates"],
  });

  // Invoice template mutations
  const createTemplateMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest("POST", "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/invoice-templates", data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/invoice-templates"] });
      toast({
        title: t("common.success"),
  ...
  const updateTemplateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/invoice-templates/${id}`,
        data,
      );
      return response.json();
    },
