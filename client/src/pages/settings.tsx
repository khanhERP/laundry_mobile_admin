...
export default function SettingsPage({ onLogout }: SettingsPageProps) {
  ...
  const confirmDeleteEmployee = async () => {
    ...
    try {
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/employees/${employeeToDelete.id}`, {
        method: "DELETE",
      });
      ...
      await queryClient.refetchQueries({
        queryKey: ["https://api-laundry-mobile.edpos.vn/api/employees"],
      });
  ...
  const { data: categoriesData, isLoading: categoriesLoading } = useQuery<
    any[]
  >({
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/categories"],
  });

  // Fetch products (include inactive products in settings)
  const { data: productsData, isLoading: productsLoading } = useQuery<any[]>({
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/products", { includeInactive: true }],
    queryFn: async () => {
      const response = await fetch("https://api-laundry-mobile.edpos.vn/api/products?includeInactive=true");
  ...
  const updateStoreSettingsMutation = useMutation({
    mutationFn: async (settings: Partial<InsertStoreSettings>) => {
      const response = await apiRequest("PUT", "https://api-laundry-mobile.edpos.vn/api/store-settings", settings);
      return response.json();
    },
    onSuccess: () => {
  ...
  const confirmDeleteCustomer = async () => {
    ...
    try {
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/customers/${customerToDelete.id}`, {
        method: "DELETE",
      });
      ...
      await queryClient.refetchQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/customers"] });
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      const response = await fetch("https://api-laundry-mobile.edpos.vn/api/categories", {
        method: "POST",
        headers: {
      ...
      await queryClient.refetchQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/categories"] });
      await queryClient.refetchQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/products"] });
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/categories/${editingCategory.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const confirmDeleteCategory = async () => {
    ...
    try {
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/categories/${categoryToDelete.id}`, {
        method: "DELETE",
      });
  ...
  const handleCreateProduct = async () => {
    try {
      ...
      const response = await fetch("https://api-laundry-mobile.edpos.vn/api/products", {
        method: "POST",
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/products/${editingProduct.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(finalProductData),
      });
  ...
  const confirmDeleteProduct = async () => {
    ...
    try {
      await apiRequest("DELETE", `https://api-laundry-mobile.edpos.vn/api/products/${productToDelete.id}`);
  ...
  const { data: eInvoiceConnections = [], isLoading: eInvoiceLoading } =
    useQuery<any[]>({
      queryKey: ["https://api-laundry-mobile.edpos.vn/api/einvoice-connections"],
    });
  ...
  const createEInvoiceMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest(
        "POST",
        "https://api-laundry-mobile.edpos.vn/api/einvoice-connections",
        data,
      );
      return response.json();
    },
  ...
  const updateEInvoiceMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://api-laundry-mobile.edpos.vn/api/einvoice-connections/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const { data: invoiceTemplates = [], isLoading: templatesLoading } = useQuery<
    any[]
  >({
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/invoice-templates"],
  });

  // Invoice template mutations
  const createTemplateMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/invoice-templates", data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/invoice-templates"] });
      toast({
        title: t("common.success"),
  ...
  const updateTemplateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://api-laundry-mobile.edpos.vn/api/invoice-templates/${id}`,
        data,
      );
      return response.json();
    },
