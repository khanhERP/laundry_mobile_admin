...
export function TableReport() {
  ...
  const { data: invoices = [], isLoading: invoicesLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://api-laundry-mobile.edpos.vn/api/invoices");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: transactions = [], isLoading: transactionsLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://api-laundry-mobile.edpos.vn/api/transactions");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: transactionItems = [], isLoading: transactionItemsLoading } =
    useQuery({
      queryKey: ["https://api-laundry-mobile.edpos.vn/api/transaction-items"],
      queryFn: async () => {
        try {
          const response = await fetch("https://api-laundry-mobile.edpos.vn/api/transaction-items");
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
          const data = await response.json();
