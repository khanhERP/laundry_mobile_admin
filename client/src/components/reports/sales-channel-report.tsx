...
export function SalesChannelReport() {
  ...
  const { data: salesChannelSalesData, isLoading: salesLoading } = useQuery({
    queryKey: [
      "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/sales-channel-sales",
      startDate,
      endDate,
      selectedSeller,
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/sales-channel-sales?${params}`);
      if (!response.ok) {
  ...
  const { data: salesChannelProfitData, isLoading: profitLoading } = useQuery({
    queryKey: [
      "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/sales-channel-profit",
      startDate,
      endDate,
      selectedSeller,
      selectedSalesChannel,
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/sales-channel-profit?${params}`);
      if (!response.ok) {
  ...
  const { data: salesChannelProductsData, isLoading: productsLoading } =
    useQuery({
      queryKey: [
        "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/sales-channel-products",
        startDate,
        endDate,
        selectedSeller,
        selectedSalesChannel,
      ...
      queryFn: async () => {
        ...
        const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/sales-channel-products?${params}`);
        if (!response.ok) {
