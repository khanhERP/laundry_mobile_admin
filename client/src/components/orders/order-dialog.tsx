...
export function OrderDialog({
  ...
  const { data: existingOrderItems, refetch: refetchExistingItems } = useQuery({
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items", existingOrder?.id],
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest(
        "GET",
        `https://api-laundry-mobile.edpos.vn/api/order-items/${existingOrder.id}`,
      );
  ...
  const createOrderMutation = useMutation({
        ...
        if (mode === "edit" && existingOrder) {
          ...
          if (orderData.items.length > 0) {
            ...
            const addItemsResponse = await apiRequest(
              "POST",
              `https://api-laundry-mobile.edpos.vn/api/orders/${existingOrder.id}/items`,
              {
          ...
          if (shouldRecalculate) {
            ...
            try {
              const recalcResponse = await apiRequest(
                "POST",
                `https://api-laundry-mobile.edpos.vn/api/orders/${existingOrder.id}/recalculate`,
              );
            ...
            for (let i = 0; i < orderData.existingItems.length; i++) {
              ...
              try {
                const updateResponse = await apiRequest(
                  "PUT",
                  `https://api-laundry-mobile.edpos.vn/api/order-items/${item.id}`,
                  {
          ...
          const updateResponse = await apiRequest(
            "PUT",
            `https://api-laundry-mobile.edpos.vn/api/orders/${existingOrder.id}`,
            {
          ...
          const response = await apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/orders", orderData);
    ...
    onSuccess: async (response) => {
      ...
      await Promise.all([
        ...
        queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items"] }),
                                    ...
                                    if (
                                      ...
                                      apiRequest(
                                        ...
                                        .then(async () => {
                                          ...
                                          queryClient.invalidateQueries({
                                            queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items"],
                                          });
                                          queryClient.invalidateQueries({
                                            queryKey: ["https://api-laundry-mobile.edpos.vn/api/orders"],
                                          });
