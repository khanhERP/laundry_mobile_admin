...
export function OrderManagement() {
  ...
  const { data: orders, isLoading: ordersLoading } = useQuery({
    queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/orders", "table"],
    ...
    queryFn: async () => {
      const response = await apiRequest(
        "GET",
        "https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/orders?salesChannel=table",
      );
      if (!response.ok) {
  ...
  const { data: orderItems, isLoading: orderItemsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest(
          "GET",
          `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/order-items/${selectedOrder.id}`,
        );
        if (!response.ok) {
          console.error(
  ...
  const updateOrderStatusMutation = useMutation({
    mutationFn: ({ orderId, status }: { orderId: number; status: string }) =>
      apiRequest("PUT", `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/orders/${orderId}/status`, { status }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/orders"] });
      queryClient.invalidateQueries({ queryKey: ["https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/tables"] });
      toast({
  ...
  const completeOrderPayment = async (orderId: number, paymentData: any) => {
    ...
    try {
      ...
      console.log("🔍 API Call Details:", {
        url: `https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/orders/${orderId}/status`,
        method: "PUT",
      ...
      const paymentDetailsResponse = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/orders/${orderId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
