...
export function ClockInOut() {
  ...
  const clockInMutation = useMutation({
    mutationFn: () =>
      apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/attendance/clock-in", {
  ...
  const clockOutMutation = useMutation({
    mutationFn: () =>
      apiRequest(
        "POST",
        `https://api-laundry-mobile.edpos.vn/api/attendance/clock-out/${(todayAttendance as AttendanceRecord)?.id}`,
        {},
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/attendance"] });
  ...
  const breakStartMutation = useMutation({
    mutationFn: () =>
      apiRequest(
        "POST",
        `https://api-laundry-mobile.edpos.vn/api/attendance/break-start/${(todayAttendance as AttendanceRecord)?.id}`,
        {},
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/attendance"] });
  ...
  const breakEndMutation = useMutation({
    mutationFn: () =>
      apiRequest(
        "POST",
        `https://api-laundry-mobile.edpos.vn/api/attendance/break-end/${(todayAttendance as AttendanceRecord)?.id}`,
        {},
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/attendance"] });
