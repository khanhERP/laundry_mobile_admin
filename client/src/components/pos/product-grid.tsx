...
export function ProductGrid({ selectedCategory, searchQuery, onAddToCart }: ProductGridProps) {
  ...
  const { data: products = [], isLoading } = useQuery<Product[]>({
    queryKey: ["https://laundry-mobie-admin.onrender.com/api/products", { category: selectedCategory, search: searchQuery }],
    queryFn: async () => {
      ...
      const response = await fetch(`https://laundry-mobie-admin.onrender.com/api/products?${params}`);
