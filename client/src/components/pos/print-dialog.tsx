  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      if (receiptData.orderId && receiptData.orderId !== 'temp-order') {
        ...
        try {
          const statusResponse = await fetch(`https://api-laundry-mobile.edpos.vn/api/orders/${receiptData.orderId}/status`, {
            method: 'PUT',
            headers: {
      ...
      try {
        ...
        const printApiResponse = await fetch('https://api-laundry-mobile.edpos.vn/api/pos/print-receipt', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              onClick={() => {
                ...
                try {
                  fetch('https://api-laundry-mobile.edpos.vn/api/popup/close', {
                    method: 'POST',
                    headers: {
                      'Content-Type': 'application/json',
                    },
