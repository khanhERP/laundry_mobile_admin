...
export function ProductManagerModal({
  ...
  const createProductMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/products/active"] });
  ...
  const updateProductMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/products/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(finalData),
      });
