...
export function EInvoiceModal({
  ...
  const completePaymentMutation = useMutation({
    mutationFn: ({
      ...
      return apiRequest("PUT", `https://laundry-mobie-admin.onrender.com/api/orders/${orderId}/status`, {
        status: "paid",
  ...
  const { data: allInvoiceTemplates = [] } = useQuery<any[]>({
    queryKey: ["https://laundry-mobie-admin.onrender.com/api/invoice-templates/active"],
    enabled: isOpen,
  });
  ...
  const handleGetTaxInfo = async () => {
    ...
    try {
      ...
      const response = await fetch("https://laundry-mobie-admin.onrender.com/api/tax-code-lookup", {
        method: "POST",
        headers: {
  ...
  const handlePublishLater = async (event?: React.MouseEvent) => {
    ...
    try {
      ...
      // Lưu hóa đơn vào bảng invoices và invoice_items
      const invoiceResponse = await fetch("https://laundry-mobie-admin.onrender.com/api/invoices", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleConfirm = async (event?: React.MouseEvent) => {
    ...
    // Call the proxy API
    const response = await fetch("https://laundry-mobie-admin.onrender.com/api/einvoice/publish", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (result.success) {
      ...
      try {
        ...
        const saveResponse = await fetch("https://laundry-mobie-admin.onrender.com/api/orders", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      try {
        const transactionResponse = await fetch("https://laundry-mobie-admin.onrender.com/api/transactions", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
