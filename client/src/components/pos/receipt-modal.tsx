  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      try {
        ...
        const printerResponse = await fetch("https://laundry-mobie-admin.onrender.com/api/printer-configs");
      ...
      if (activePrinterConfigs.length > 0) {
        ...
        try {
          const printResponse = await fetch("https://laundry-mobie-admin.onrender.com/api/pos/print-receipt", {
            method: "POST",
            headers: {
