...
export function PrinterConfigModal({
  ...
  const { data: printerConfigs = [], isLoading } = useQuery({
    queryKey: ["https://laundry-mobie-admin.onrender.com/api/printer-configs"],
    queryFn: async () => {
      const response = await apiRequest("GET", "https://laundry-mobie-admin.onrender.com/api/printer-configs");
  ...
  const createConfigMutation = useMutation({
    mutationFn: async (configData: any) => {
      const response = await apiRequest(
        "POST",
        "https://laundry-mobie-admin.onrender.com/api/printer-configs",
        configData,
      );
      return response.json();
    },
    onSuccess: () => {
      // Force refetch data
      queryClient.invalidateQueries({ queryKey: ["https://laundry-mobie-admin.onrender.com/api/printer-configs"] });
      queryClient.refetchQueries({ queryKey: ["https://laundry-mobie-admin.onrender.com/api/printer-configs"] });
  ...
  const updateConfigMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://laundry-mobie-admin.onrender.com/api/printer-configs/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const deleteConfigMutation = useMutation({
    mutationFn: async (id: number) => {
      await apiRequest("DELETE", `https://laundry-mobie-admin.onrender.com/api/printer-configs/${id}`);
    },
    onSuccess: () => {
      // Force refetch data
      queryClient.invalidateQueries({ queryKey: ["https://laundry-mobie-admin.onrender.com/api/printer-configs"] });
  ...
  const testConnectionMutation = useMutation({
    mutationFn: async (id: number) => {
      const response = await apiRequest(
        "POST",
        `https://laundry-mobie-admin.onrender.com/api/printer-configs/${id}/test`,
      );
      return response.json();
    },
    onSuccess: (data) => {
