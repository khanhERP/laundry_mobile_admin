...
export function TableGrid({ onTableSelect, selectedTableId }: TableGridProps) {
  ...
  useEffect(() => {
    const handlePrintCompleted = (event: CustomEvent) => {
      ...
      // Refresh data
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"] });
  ...
  const {
    ...
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"],
  ...
  const { data: orders, refetch: refetchOrders } = useQuery({
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/orders"],
  ...
  const {
    ...
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items", selectedOrder?.id],
    ...
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest("GET", `https://api-laundry-mobile.edpos.vn/api/order-items/${orderId}`);
  ...
  const { data: products } = useQuery({
    queryKey: ["https://api-laundry-mobile.edpos.vn/api/products"],
  ...
  useEffect(() => {
    if (orderDetailsOpen && selectedOrder?.id) {
      const cachedData = queryClient.getQueryData([
        "https://api-laundry-mobile.edpos.vn/api/order-items",
        selectedOrder.id,
      ]);
      if (!cachedData) {
        console.log(
    ...
    const handleOrderUpdate = (event: CustomEvent) => {
      ...
      if (!event.detail?.skipAllRefetch && event.detail?.orderId) {
        queryClient.invalidateQueries({
          queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items", event.detail.orderId],
        });
      }
    };
  ...
  useEffect(() => {
    ...
    const connectWebSocket = () => {
      try {
        ...
        const wsUrl = `https://api-laundry-mobile.edpos.vn/ws`;
            ...
            if (
              ...
              try {
                ...
                const [freshTables, freshOrders] = await Promise.all([
                  fetch(
                    `https://api-laundry-mobile.edpos.vn/api/tables?_ws_refresh=${cacheBuster}&_force=true&_timestamp=${timestamp}`,
                    {
                      cache: "no-store",
                      headers: {
                  ...
                  fetch(
                    `https://api-laundry-mobile.edpos.vn/api/orders?_ws_refresh=${cacheBuster}&_force=true&_timestamp=${timestamp}`,
                    {
                      cache: "no-store",
                      headers: {
                        "Cache-Control": "no-cache, no-store, must-revalidate",
                ...
                queryClient.setQueryData(["https://api-laundry-mobile.edpos.vn/api/tables"], freshTables);
                queryClient.setQueryData(["https://api-laundry-mobile.edpos.vn/api/orders"], freshOrders);
                ...
                setTimeout(() => {
                  ...
                  queryClient.refetchQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"] });
                  queryClient.refetchQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/orders"] });
                }, 200);
            ...
            try {
              ...
              for (const order of tableOrders) {
                ...
                const response = await apiRequest(
                  "GET",
                  `https://api-laundry-mobile.edpos.vn/api/order-items/${order.id}`,
                );
  ...
  const updateTableStatusMutation = useMutation({
    mutationFn: ({ tableId, status }: { tableId: number; status: string }) =>
      apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/tables/${tableId}/status`, { status }),
    onSuccess: async (data, variables) => {
      ...
      queryClient.removeQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"] });
      queryClient.removeQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/orders"] });
  ...
  const completePaymentMutation = useMutation({
    mutationFn: ({
      ...
      apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/orders/${orderId}/status`, {
        status: "paid",
        paymentMethod,
      }),
    onSuccess: async (data, variables) => {
        ...
        try {
          ...
          if (otherActiveOrders.length === 0) {
            ...
            try {
              await apiRequest(
                "PUT",
                `https://api-laundry-mobile.edpos.vn/api/tables/${completedOrder.tableId}/status`,
                {
                  status: "available",
                },
              );
      ...
      try {
        ...
        const [freshTables, freshOrders] = await Promise.all([
          fetch("https://api-laundry-mobile.edpos.vn/api/tables", {
            cache: "no-store",
            headers: { "Cache-Control": "no-cache" },
          }).then((r) => r.json()),
          fetch("https://api-laundry-mobile.edpos.vn/api/orders", {
            cache: "no-store",
            headers: { "Cache-Control": "no-cache" },
          }).then((r) => r.json()),
        ]);
      ...
      try {
        const [completedOrder, orderItemsData] = await Promise.all([
          queryClient.fetchQuery({
            queryKey: ["https://api-laundry-mobile.edpos.vn/api/orders", variables.orderId],
            queryFn: async () => {
              const response = await apiRequest(
                "GET",
                `https://api-laundry-mobile.edpos.vn/api/orders/${variables.orderId}`,
              );
              return response.json();
            },
          }),
          queryClient.fetchQuery({
            queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items", variables.orderId],
            queryFn: async () => {
              const response = await apiRequest(
                "GET",
                `https://api-laundry-mobile.edpos.vn/api/order-items/${variables.orderId}`,
              );
              return response.json();
            },
          }),
  ...
  const pointsPaymentMutation = useMutation({
    mutationFn: async ({
      ...
      // First redeem points
      await apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/customers/redeem-points", {
        customerId,
        points,
      });

      // Then mark order as paid
      await apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/orders/${orderId}/status`, {
        status: "paid",
  ...
  const deleteOrderMutation = useMutation({
    mutationFn: async (orderId: number) => {
      ...
      const response = await apiRequest(
        "PUT",
        `https://api-laundry-mobile.edpos.vn/api/orders/${orderId}/status`,
        { status: "cancelled" },
      );
      ...
      if (order?.tableId) {
        ...
        if (!otherActiveOrders || otherActiveOrders.length === 0) {
          await apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/tables/${order.tableId}/status`, {
            status: "available",
          });
        }
      }
    ...
    onSuccess: (data, orderId) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"] });
      queryClient.invalidateQueries({
        queryKey: ["https://api-laundry-mobile.edpos.vn/api/order-items", orderId],
  ...
  const recalculateOrderTotalMutation = useMutation({
    mutationFn: async (orderId: number) => {
      ...
      if (!remainingItems || remainingItems.length === 0) {
        ...
        const updateResult = await apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/orders/${orderId}`, {
          subtotal: "0",
          tax: "0",
          total: "0",
        });
    ...
    onSuccess: (data, orderId) => {
      ...
      Promise.all([
        fetch("https://api-laundry-mobile.edpos.vn/api/orders", { cache: "no-store" }).then((r) => r.json()),
        fetch("https://api-laundry-mobile.edpos.vn/api/tables", { cache: "no-store" }).then((r) => r.json()),
        fetch(`https://api-laundry-mobile.edpos.vn/api/order-items/${orderId}`, { cache: "no-store" }).then((r) =>
          r.json(),
        ),
      ])
        .then(() => {
          ...
          queryClient.setQueryData(["https://api-laundry-mobile.edpos.vn/api/orders"], (oldData: any) => {
  ...
  const handlePaymentMethodSelect = async (
    ...
    if (method === "paymentCompleted" && paymentData?.success) {
      ...
      try {
        ...
        const [freshTables, freshOrders] = await Promise.all([
          fetch(
            "https://api-laundry-mobile.edpos.vn/api/tables?" +
              new URLSearchParams({
          ...
          fetch(
            "https://api-laundry-mobile.edpos.vn/api/orders?" +
              new URLSearchParams({
                _t: Date.now().toString(),
                _force: "true",
              }),
  ...
  const handlePrintOrder = async (order: any) => {
    ...
    try {
      const orderItems = await queryClient.fetchQuery({
        queryKey: [`https://api-laundry-mobile.edpos.vn/api/order-items/${order.id}`],
        queryFn: async () => {
          const response = await apiRequest(
            "GET",
            `https://api-laundry-mobile.edpos.vn/api/order-items/${order.id}`,
      ...
      const response = await fetch("https://api-laundry-mobile.edpos.vn/api/auto-print", {
        method: "POST",
        headers: {
        ...
        <ReceiptModal
          ...
          onClose={async () => {
            ...
            try {
              ...
              const timestamp = Date.now().toString();
              const [freshTables, freshOrders] = await Promise.all([
                fetch(`https://api-laundry-mobile.edpos.vn/api/tables?_t=${timestamp}&_force=refresh`, {
                  cache: "no-store",
                  headers: {
                    "Cache-Control": "no-cache, no-store, must-revalidate",
                    Pragma: "no-cache",
                ...
                fetch(`https://api-laundry-mobile.edpos.vn/api/orders?_t=${timestamp}&_force=refresh`, {
                  cache: "no-store",
                  headers: {
                    "Cache-Control": "no-cache, no-store, must-revalidate",
                    Pragma: "no-cache",
