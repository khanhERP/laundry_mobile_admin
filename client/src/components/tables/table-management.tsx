...
export function TableManagement() {
  ...
  const createTableMutation = useMutation({
    mutationFn: (data: TableFormData) =>
      apiRequest("POST", "https://api-laundry-mobile.edpos.vn/api/tables", data),
    onSuccess: () => {
  ...
  const updateTableMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: TableFormData }) =>
      apiRequest("PUT", `https://api-laundry-mobile.edpos.vn/api/tables/${id}`, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"] });
      toast({
        title: t("common.success"),
  ...
  const deleteTableMutation = useMutation({
    mutationFn: (id: number) => apiRequest("DELETE", `https://api-laundry-mobile.edpos.vn/api/tables/${id}`, {}),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://api-laundry-mobile.edpos.vn/api/tables"] });
      toast({
        title: t("common.success"),
