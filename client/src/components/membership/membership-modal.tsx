...
export function MembershipModal({ isOpen, onClose }: MembershipModalProps) {
  ...
  const { data: fetchedThresholds } = useQuery<{ GOLD: number; VIP: number }>({
    queryKey: ['https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/membership-thresholds'],
    enabled: isOpen,
  });
  ...
  const updateMembershipMutation = useMutation({
    mutationFn: async ({ customerId, membershipLevel }: { customerId: number; membershipLevel: string }) => {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/customers/${customerId}`, {
        method: 'PUT',
        headers: {
  ...
  const updateThresholdsMutation = useMutation({
    mutationFn: async (newThresholds: { GOLD: number; VIP: number }) => {
      const response = await fetch('https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/membership-thresholds', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/membership-thresholds'] });
      queryClient.invalidateQueries({ queryKey: ['https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/customers'] });
      toast({
        title: t("common.success"),
