...
export function CustomerPointsModal({
  ...
  const { data: pointsData, isLoading: pointsLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/customers/${customerId}/points`);
  ...
  const { data: pointHistory, isLoading: historyLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://api-laundry-mobile.edpos.vn/api/customers/${customerId}/point-history`);
