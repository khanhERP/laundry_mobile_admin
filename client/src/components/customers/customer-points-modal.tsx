...
export function CustomerPointsModal({
  ...
  const { data: pointsData, isLoading: pointsLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/customers/${customerId}/points`);
  ...
  const { data: pointHistory, isLoading: historyLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://25da17e5-7ac2-4890-934e-e5dd4883f884-00-1yx4zdislv1l0.pike.replit.dev/api/customers/${customerId}/point-history`);
